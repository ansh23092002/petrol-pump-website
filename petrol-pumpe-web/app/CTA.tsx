  ...
  return (
    <section className="bg-[#143f73] py-20" ref={sectionRef}>
      <div className="mx-auto max-w-5xl px-6 text-center text-white">
        {/* Icon */}
        <div className="cta-animate mb-4 flex justify-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-lg border border-orange-400 text-orange-400">
            <Smartphone size={24} />
          </div>
        </div>
        {/* Heading */}
        <h2 className="cta-animate text-2xl md:text-3xl font-bold">
          Ready to Transform Your Fuel Business?
        </h2>
        {/* Sub text */}
        <p className="cta-animate mt-3 text-sm text-white/80 max-w-xl mx-auto">
          Join thousands of petrol pump owners who trust FuelTrack for their
          daily operations.
        </p>
        {/* CTA Button */}
        <div className="cta-animate mt-8 flex justify-center">
        ...
        {/* Footer text */}
        <p className="cta-animate mt-6 text-xs text-white/70">
