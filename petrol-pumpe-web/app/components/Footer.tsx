  ...
  return (
    <footer ref={sectionRef} className="relative  bg-gray-100">
      ...
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
        <span className="select-none text-8xl md:text-[10rem] lg:text-[12rem] font-extrabold text-[#3755AE] opacity-6 transform -translate-y-6">
          FuelTrack
        </span>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="bg-transparent px-6 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            <p>© {new Date().getFullYear()} Inext Software Solutions. All Rights Reserved.</p>
            <div className="flex gap-5">
              <Link href="/terms" className="hover:text-slate-900 cursor-pointer transition">Terms of Agreement</Link>
              <Link href="/privacy" className="hover:text-slate-900 cursor-pointer transition">Privacy Policy</Link>
              <Link href="/refund" className="hover:text-slate-900 cursor-pointer transition">Refund Policy</Link>
              <Link href="/faqs" className="hover:text-slate-900 cursor-pointer transition">FAQs</Link>
            </div>
          </div>
        </div>
      </div>
